...
Chapter 1 is available. Chapters 2–24 are planned; their titles and scope may develop as the series is written.
...
**02. What do cameras, lidar, and radar actually measure?** — *Planned*  
Understand the evidence each sensor provides and the conditions that make it unreliable.

**03. How does a neural network learn to recognize a car?** — *Planned*  
Learn the essentials of features, training examples, losses, and generalization.

**04. How does a pixel become a position on the road?** — *Planned*  
